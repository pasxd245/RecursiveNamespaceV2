...
@click.option('--classifier', type=click.Choice(['lr', 'rf', 'ada']), default='rf', help='The Classifier model. rf: Random Forest, lr: Logistic Regression, ada: AdaBoost.')
def evaluate(**options):
    ...
    for k,v in results.items(): # results is rns type. But you can treat is as dictionary.
