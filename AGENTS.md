...
1. **Hardcoding version strings** - Version is derived from git tags at
   build time (via hatch-vcs). Do not hardcode version strings.
...
3. **Check for open TODOs** - Review `.agents/plan/PDCA.md` for context
